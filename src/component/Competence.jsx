        ...
        <>
            ...
            <div className="w-full mt-[8vh] sm:mt-[19vh] hidden md:block">
                <div className="mt-[10%] flex">
                    <div className='haut'>
                        <div className=" absolute p-[0.7rem] ml-[-10px] rounded-full haut gradien"></div>
                        <div className=" absolute p-[0.7rem] ml-[-10px] mt-[23vh] haut1  rounded-full gradien"></div>
                        <div className=" absolute p-[0.7rem] ml-[-10px] mt-[53vh] haut1  rounded-full gradien"></div>
                    ...
                    <div className='lg:ml-[3vw]'>
                        ...
                        <div className="w-full relative flex gap-5 droite2">
                            <div className=' ml-5 lg:ml-0'>
                                <div onClick={front} style={{ boxShadow: "-0px -0px 5px #507CFA" }} className="gauche1 gradien col-span-6 rounded px-3 py-0 cursor-pointer ">
                                    <div className='flex justify-between mt-2'>
                                        <p className='text-[1.2rem] text-gray-200 mt-2 font'>Frontend</p>
                                        <FaCode className='text-[1.7rem] mt-2 text-gray-200' />
                                    </div>
                                    <p className='text-[0.9rem] text-gray-300'>En utilisant React, VueJs pour le partie pour
                                        Web et React Native pour interface mobile</p>
                                    <p id='text1' className='text-[1.7rem]'>0 1</p>
                                </div>
                                <div onClick={back} style={{ boxShadow: "-0px -0px 5px #507CFA" }} className="gauche2 mang col-span-6 rounded px-3 py-0 cursor-pointer">
                                    <div className='flex justify-between mt-2'>
                                        <p className='text-[1.2rem] text-gray-400 mt-2 font'>Backend</p>
                                        <FaCode className='text-[1.7rem] mt-2 text-gray-500' />
                                    </div>
                                    <p className='text-[0.9rem] text-gray-300'>En utilisant Laravel,Symfony et Node Express</p>
                                ...
                                <div onClick={design} style={{ boxShadow: "-0px -0px 5px #507CFA" }} className="gauche3 col-span-6 rounded px-3 py-0 cursor-pointer">
                                    ...
                                    <p className='text-[0.9rem] text-gray-500'>En utilisant Adobe Photoshop , Figma et Adobe
                            ...
                            <div id='front' className=' col-span-6 p-2 ml-3'>
                                <p className='text-[1.2rem] text-gray-300 font'>Competences pour <span className='gradien ml-3 px-3 rounded'>Frontend</span></p>
                                <div className="">
                                    <div className="w-20 rounded p-1 gradien"></div>
                                    <p className='mt-[-2.5vh] text-[0.9rem] ml-[7rem] text-gray-100'>Outils</p>
                                </div>
                                ...
                                <div style={{ boxShadow: "-0px -0px 4px #507CFA" }} className="flex ml-4 w-[90%] text-center">
                                    ...
                                    <p className='sm:mt-[2.8rem] gradien text-gray-100 h-[100%] text-[0.9rem]'>Gestion des réservations des places</p>
                                </div>
                            </div>
                            ...
                            <div id='back' className='col-span-6 p-2 ml-3 hidden'>
                                <p className='text-[1.2rem] text-gray-300 font'>Competences pour <span className='gradien ml-3  px-3 rounded'>Backend</span></p>
                                <div className="">
                                    <div className="w-20 rounded p-1 gradien"></div>
                                    <p className='mt-[-2.5vh] text-[0.9rem] ml-[7rem] text-gray-100'>Outils</p>
                                </div>
                            ...
                            <div id='design' className='col-span-6 p-2 ml-3 hidden'>
                                <p className='text-[1.2rem] text-gray-300 font'>Competences pour <span className='gradien ml-3  px-3 rounded'>Design</span></p>
                                <div className="">
                                    <div className="w-20 rounded p-1 gradien"></div>
                                    <p className='mt-[-2.5vh] text-[0.9rem] ml-[7rem] text-gray-100'>Outils</p>
                                </div>
            ...
            <div className='block md:hidden mt-8'>
                ...
                <div className="flex gap-x-[5vw]">
                    <div>
                        <div className=" absolute p-[0.7rem] ml-[-10px] rounded-full gradien bas1"></div>
                        <div className=" absolute p-[0.7rem] ml-[-10px] mt-[23vh]  rounded-full gradien bas2"></div>
                        <div className=" absolute p-[0.7rem] ml-[-10px] mt-[53vh] rounded-full gradien bas3"></div>
                        <div className="h-[135vh] w-[0.1rem] bg-gray-600 bas"></div>
                    </div>

                    <div>

                        <div onClick={front1} style={{ boxShadow: "-0px -0px 5px #507CFA" }} className="gauche2 gradien col-span-6 w-[97%] rounded px-3 py-0">
                            <div className='flex justify-between mt-2'>
                                <p className='text-[1.2rem] text-gray-200 mt-2 font'>Frontend</p>
                                <FaCode className='text-[1.7rem] mt-2 text-gray-200' />
                            </div>
                        ...
                        <div id='front1' className='col-span-6 p-2 ml-3'>
                            <p className='text-[1.2rem] text-gray-300 font bas4'>Competences pour <span className='gradien ml-3 px-3 rounded'>Frontend</span></p>
                            <div className="bas5">
                                <div className="w-20 rounded p-1 gradien"></div>
                                <p className='gradien px-3 rounded mt-[-2.5vh] text-[0.9rem] ml-[7rem] text-gray-100'>Outils</p>
                            </div>
                            ...
                            <div style={{ boxShadow: "-0px -0px 4px #507CFA" }} className="ml-4 w-[90%] text-center bas5">
                                ...
                                <p className='mt-[2.8rem] gradien text-gray-100 text-[0.9rem]'>Gestion des réservations des places</p>
                            </div>
                        </div>

                        <div onClick={back1} style={{ boxShadow: "-0px -0px 5px #507CFA" }} className="gauche3 mang col-span-6 w-[97%]  rounded px-3 py-0">
                            <div className='flex justify-between mt-2'>
                                <p className='text-[1.2rem] text-gray-300 mt-2 font'>Backend</p>
                                <FaCode className='text-[1.7rem] mt-2 text-gray-400' />
                            </div>
                            <p className='text-[0.9rem] text-gray-400'>En utilisant Laravel,Symfony et Node Express</p>
                            <p id='text1' className='text-[1.7rem]'>0 2</p>
                        </div>
                        ...
                        <div id='back1' className='col-span-6 p-2 ml-3 hidden'>
                                ...
                                <div className="">
                                    <div className="w-20 rounded p-1 gradien"></div>
                                    <p className='gradien mt-[-2.5vh] text-[0.9rem] ml-[7rem] text-gray-100'>Outils</p>
                                </div>
                                <div className="grid grid-cols-2 gap-x-[10rem] gap-y-5">
                                    <div className='text-center col-span-1'>
                                        <FaPhp className='text-[3.1rem] text-gray-400' />
